...
@Component({
  ...
  template: `
    <div class="stats-grid">
      @for (estatistica of estatisticas; track trackEstatistica($index, estatistica)) {
        <div class="stat-card" [style.animation-delay.s]="$index * 0.1">
          <div class="stat-content">
            ...
            <div class="stat-main">
              ...
              @if ((estatistica.porcentagem || estatistica.percentual_mudanca) !== undefined) {
                <div class="stat-trend" [class]="getTrendClass(estatistica.tipo)">
                  <i [class]="'pi ' + getTrendIcon(estatistica.tipo || 'neutro') + ' trend-icon'"></i>
                  <span class="trend-text">{{ estatistica.porcentagem || estatistica.percentual_mudanca }}%</span>
                </div>
              }
            </div>
          </div>
...
export class GradeEstatisticasComponent {
  @Input() estatisticas: Estatistica[] = [];
